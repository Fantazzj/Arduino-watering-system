...
constexpr Clay_Color VALVE_ON_COLOR = {100, 255, 150, 255};
constexpr Clay_Color VALVE_OFF_COLOR = {101, 157, 213, 255};

constexpr Clay_Color VALVE_MAINSWITCH_OFF_COLOR = {100, 120, 150, 255};
constexpr Clay_Color VALVE_MAINSWITCH_ON_COLOR = {149, 182, 120, 255};
