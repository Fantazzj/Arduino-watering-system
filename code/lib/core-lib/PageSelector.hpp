...
public:
	explicit PageSelector(Keypad& myKeypad, UnitDisplay& myDisplay, Clock& myClock, ValveGroupN& myEtv, MainSwitch& _myMainSwitch, Memory& myMemory, Timer& myTimer, AutoCycle& autoCycle);
	void begin();
	void exec();
	void show();
